...
# Cookbooks v5.3.0 Version Compatibility

This page helps clarify the supported versions of ArcGIS and Chef for Chef Cookbooks for ArcGIS releases.

* Supported Chef Client Versions: 15.3 and above
* Recommended Chef Client Version: 18.8.46
* Recommended Cinc Client Version: 18.8.46
