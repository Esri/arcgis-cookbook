...
* `node['arcgis']['mission_server']['setup']` = The location of the ArcGIS Mission Server setup executable. Default location is `%USERPROFILE%\Documents\ArcGIS11.4\MissionServer\Setup.exe` on Windows and `/opt/arcgis/11.4/MissionServer/Setup` on Linux.
