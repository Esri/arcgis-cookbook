...
arcgis_license_manager_licensemanager 'Verify ArcGIS License Manager system requirements' do
  action :system
end

arcgis_license_manager_licensemanager 'Unpack ArcGIS License Manager Setup' do
...
arcgis_license_manager_licensemanager 'Install ArcGIS License Manager' do
