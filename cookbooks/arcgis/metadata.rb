...
depends          'arcgis-desktop', '~> 4.0'
depends          'arcgis-egdb', '~> 1.0'
depends          'arcgis-enterprise', '~> 4.0'
depends          'arcgis-geoevent', '~> 4.0'
depends          'arcgis-notebooks', '~> 4.0'
depends          'arcgis-mission', '~> 4.0'
depends          'arcgis-insights', '~> 4.0'
depends          'arcgis-pro', '~> 4.0'
depends          'arcgis-repository', '~> 4.0'
depends          'arcgis-workflow-manager', '~> 4.0'
