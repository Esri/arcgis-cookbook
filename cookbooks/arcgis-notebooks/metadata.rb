...
recipe 'arcgis-notebooks::samples_data', '(DEPRECATED) Installs ArcGIS Notebook Server Samples Data'
...
recipe 'arcgis-notebooks::uninstall_samples_data', 'Uninstalls ArcGIS Notebook Server Samples Data'
