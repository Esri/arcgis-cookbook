...
# Import public key of ArcGIS Video Server SSL certificate into portal as 
...
arcgis_enterprise_portal 'Federate Video Server' do
  portal_url node['arcgis']['portal']['private_url']
  username node['arcgis']['portal']['admin_username']
  password node['arcgis']['portal']['admin_password']
  server_url node['arcgis']['video_server']['web_context_url']
  server_admin_url node['arcgis']['video_server']['private_url']
  server_username node['arcgis']['video_server']['admin_username']
  server_password node['arcgis']['video_server']['admin_password']
  is_hosting false
  retries 5
  retry_delay 30
...
arcgis_enterprise_portal 'Enable VideoServer server function' do
  portal_url node['arcgis']['portal']['private_url']
  username node['arcgis']['portal']['admin_username']
  password node['arcgis']['portal']['admin_password']
  server_url node['arcgis']['video_server']['web_context_url']
