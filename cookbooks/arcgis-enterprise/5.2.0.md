...
* `node['arcgis']['version']` = ArcGIS version. Default value is `11.5`.
...
* `node['arcgis']['server']['unpack_options']` = ArcGIS Server windows self-extracting archive command line options. Default value is `/x` for ArcGIS Server 11.5 and `''` for older versions.
...
* `node['arcgis']['portal']['authorization_file_version']` = Portal for ArcGIS authorization file version. Default value is `11.5`.
...
* `node['arcgis']['portal']['unpack_options']` = Portal for ArcGIS windows self-extracting archive command line options. Default value is `/x` for Portal for ArcGIS 11.5 and `''` for older versions.
...
```JSON
{
  "arcgis": {
    ...
    "data_store": {
      "setup": "C:\\ArcGIS\\11.5\\Setups\\DataStore\\Setup.exe",
...
```JSON
{
  "arcgis": {
    ...
    "run_as_password": "<password>",
    "server": {
      "setup": "C:\\ArcGIS\\11.5\\Setups\\Server\\Setup.exe",
      "install_dir": "C:\\Program Files\\ArcGIS\\Server",
      "wa_name": "server"
    },
    "portal": {
      "setup": "C:\\ArcGIS\\11.5\\Setups\\Portal\\Setup.exe",
      "install_dir": "C:\\Program Files\\ArcGIS\\Portal",
      "wa_name": "portal"
    },
    "data_store": {
    ...
    "web_adaptor": {
      "setup": "C:\\ArcGIS\\11.5\\Setups\\WebAdaptorIIS\\Setup.exe",
      "install_dir": ""
    },
    "python": {
...
```JSON
{
  "arcgis": {
    "server": {
      "setup": "C:\\ArcGIS\\11.5\\Setups\\Server\\Setup.exe",
      "authorization_file": "C:\\ArcGIS\\11.5\\Authorization_Files\\Server.prvc"
    },
    "portal": {
      "setup": "C:\\ArcGIS\\11.5\\Setups\\Portal\\Setup.exe",
      "authorization_file": "C:\\ArcGIS\\11.5\\Authorization_Files\\Portal.json"
    },
    "data_store": {
      "setup": "C:\\ArcGIS\\11.5\\Setups\\DataStore\\SetupFile\\Setup.exe"
    },
    "web_adaptor": {
      "setup": "C:\\ArcGIS\\11.5\\Setups\\WebAdaptorIIS\\Setup.exe"
    }
...
```JSON
{
  "arcgis": {
    ...
    "run_as_password": "<password>",
    "data_store": {
      "setup": "C:\\Users\\Administrator\\Documents\\ArcGIS 11.5\\ArcGISDataStore\\Setup.exe",
      "install_dir": "C:\\Program Files\\ArcGIS\\DataStore",
      "data_dir": "C:\\arcgisdatastore",
      "backup_dir": "C:\\arcgisdatastore\\backup",      
      "install_system_requirements": true,
...
```JSON
{
  "arcgis": {
    ...
    "run_as_password": "<password>",
    "portal": {
      "setup": "C:\\Users\\Administrator\\Documents\\ArcGIS 11.5\\PortalForArcGIS\\Setup.exe",
      "install_dir": "C:\\Program Files\\ArcGIS\\Portal",
      "install_system_requirements":  true,
      "configure_autostart": true,
      "data_dir": "C:\\arcgisportal"
...
```JSON
{
  "arcgis": {
    "version": "11.5",
    "web_adaptor": {
      "setup": "C:\\Users\\Administrator\\Documents\\ArcGIS 11.5\\WebAdaptorIIS\\Setup.exe",
      "install_dir": "",
      "install_system_requirements": true
    },
    "portal": {
...
```JSON
{
  "arcgis": {
    ...
    "run_as_password": "<password>",
    "server": {
      "setup": "C:\\Users\\Administrator\\Documents\\ArcGIS 11.5\\ArcGISServer\\Setup.exe",
      "install_dir": "C:\\Program Files\\ArcGIS\\Server",
      "install_system_requirements": true,
      "configure_autostart": true
    },
...
```JSON
{
  "arcgis": {
    "version": "11.5",
    "server": {
      "lp-setup": "C:\\ArcGIS\\11.5\\Setups\\Server\\Japanese\\setup.msi"
    },
    "portal": {
      "lp-setup": "C:\\ArcGIS\\11.5\\Setups\\Portal\\Japanese\\setup.msi"
    },
    "data_store": {
      "lp-setup": "C:\\ArcGIS\\11.5\\Setups\\DataStore\\Japanese\\setup.msi"
    },
    "web_adaptor": {
      "lp-setup": "C:\\ArcGIS\\11.5\\Setups\\WebAdaptorIIS\\Japanese\\setup.msi"
    }
  },
  "run_list": [
...
```JSON
{
  "arcgis": {
    ...
    "portal": {
      "setup": "C:\\ArcGIS\\11.5\\Setups\\Portal\\Setup.exe",
      "install_dir": "C:\\Program Files\\ArcGIS\\Portal",
      "authorization_file": "C:\\ArcGIS\\11.5\\Authorization_Files\\Portal.prvc",
      "authorization_file_version": "11.5",
      "install_system_requirements":  true,
      "configure_autostart": true,
      "data_dir": "C:\\arcgisportal",
...
```JSON
{
  "arcgis": {
    ...
    "web_adaptor":{
      "setup": "/arcgis/11.5/WebAdaptor/CD_Linux/Setup",
      "install_dir": "/",
      "install_system_requirements": true
    },
    "portal": {
...
```JSON
{
  "arcgis": {
   "version":"11.5",
    "webstyles": {
      "setup":"C:\\ArcGIS\\11.5\\Setups\\ArcGIS 11.5\\ArcGISWebStyles\\Setup.exe"
    }
  },
  "run_list": [
