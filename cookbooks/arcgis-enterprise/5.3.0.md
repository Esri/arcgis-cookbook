...
* `node['arcgis']['version']` = ArcGIS version. Default value is `12.0`.
...
* `node['arcgis']['run_as_group']` = Name of user group used to run ArcGIS Server, Portal for ArcGIS, and ArcGIS Data Store. Default group name is `arcgis`.
...
* `node['arcgis']['server']['primary_server_url']` = URL of ArcGIS Server site to join (`https://<FQDN of the primary machine>:6443/arcgis`). Default URL is `nil`.
...
* `node['arcgis']['server']['cloud_config']` = ArcGIS Server cloud native configuration JSON. When arcgis.server.cloud_config attribute is set, values of arcgis.server.directories_root, arcgis.server.config_store_type, and arcgis.server.config_store_connection_string attributes are ignored. Supported from ArcGIS Server 12.0. Default value is `''`.
...
* `node['arcgis']['server']['hsts_enabled']` = Enable HTTP Strict Transport Security in ArcGIS Server. Default value is `false`.
...
* `node['arcgis']['server']['services_dir_enabled']` = Enables or disables ArcGIS Server services directory. Default value is `true`.
* `node['arcgis']['server']['callback_functions_enabled']` = Enables or disables JSONP callback functions in ArcGIS Server. Default value is `true`.
* `node['arcgis']['server']['unpack_options']` = ArcGIS Server windows self-extracting archive command line options. Default value is `/x` for ArcGIS Server 12.0 and `''` for older versions.
...
* `node['arcgis']['web_adaptor']['admin_access']` = (DEPRECATED) Indicates if ArcGIS Server Manager and Admin API will be available through the Web Adaptor `<true|false>`. Default value is `true`.
...
* `node['arcgis']['portal']['primary_machine_url']` = URL of primary Portal for ArcGIS machine (`https://<FQDN of the primary machine>:7443/arcgis`). Default URL is `nil`.
...
* `node['arcgis']['portal']['admin_email']` = Initial portal administrator e-mail. Default e-mail is `nil`.
...
* `node['arcgis']['portal']['security_question_index']` = Initial portal administrator security question index. Default index is `1`
* `node['arcgis']['portal']['security_question_answer']` = Initial portal administrator security question answer. Default answer is `nil`.
...
* `node['arcgis']['portal']['authorization_file_version']` = Portal for ArcGIS authorization file version. Default value is `12.0`.
...
* `node['arcgis']['portal']['hsts_enabled']` = Enable HTTP Strict Transport Security in Portal for ArcGIS. Default value is `false`.
...
* `node['arcgis']['portal']['organization']` = Portal for ArcGIS organization information. Default value is `{'allSSL' => true, 'access' => 'public'}`.
...
* `node['arcgis']['portal']['unpack_options']` = Portal for ArcGIS windows self-extracting archive command line options. Default value is `/x` for Portal for ArcGIS 12.0 and `''` for older versions.
...
* `node['arcgis']['portal']['email_settings']` = Portal for ArcGIS email settings. Default value is `nil`.
* `node['arcgis']['portal']['user_default_settings']` = Portal for ArcGIS user default settings. Default value is `nil`.
* `node['arcgis']['portal']['settings']` = Portal for ArcGIS organization settings. Default value is `{}`.
...
* `node['arcgis']['data_store']['types']` = Comma-separated list of ArcGIS Data Store types to be created, `<relational|tileCache|spatiotemporal|graph|object>`. The default value is `object,relational`.
...
* `node['arcgis']['data_store']['relational']['disk_threshold_readonly']` = Sizes in MB when a relational data store will be placed in read-only mode to avoid loss of data due to insufficient disk space. The default value is `5120`.
* `node['arcgis']['data_store']['relational']['max_connections']` = Maximum number of connections allowed to a relational data store. The default value is `150`.
* `node['arcgis']['data_store']['relational']['pitr']` = Enables or disables point-in-time recovery of a relational data store. Allowed values are `'enable'` and `'disable'`. The default value is `'disable'`.
* `node['arcgis']['data_store']['relational']['enablessl']` = Enables use TLS protocol for communication between the relational data store and the hosting server. The default value is `true`.
...
```JSON
{
  "arcgis": {
    ...
    "data_store": {
      "setup": "C:\\ArcGIS\\12.0\\Setups\\DataStore\\Setup.exe",
...
```JSON
{
  ...
  "run_list": [
    "recipe[arcgis-enterprise::delete_server_site]"
  ]
}
```
...
```JSON
{
  "arcgis": {
    ...
    "run_as_password": "<password>",
    "server": {
      "setup": "C:\\ArcGIS\\12.0\\Setups\\Server\\Setup.exe",
      "install_dir": "C:\\Program Files\\ArcGIS\\Server",
      "wa_name": "server"
    },
    "portal": {
      "setup": "C:\\ArcGIS\\12.0\\Setups\\Portal\\Setup.exe",
      "install_dir": "C:\\Program Files\\ArcGIS\\Portal",
      "wa_name": "portal"
    },
    "data_store": {
    ...
    "web_adaptor": {
      "setup": "C:\\ArcGIS\\12.0\\Setups\\WebAdaptorIIS\\Setup.exe",
      "install_dir": ""
    },
    "python": {
...
```JSON
{
  "arcgis": {
    "server": {
      "setup": "C:\\ArcGIS\\12.0\\Setups\\Server\\Setup.exe",
      "authorization_file": "C:\\ArcGIS\\12.0\\Authorization_Files\\Server.prvc"
    },
    "portal": {
      "setup": "C:\\ArcGIS\\12.0\\Setups\\Portal\\Setup.exe",
      "authorization_file": "C:\\ArcGIS\\12.0\\Authorization_Files\\Portal.json"
    },
    "data_store": {
      "setup": "C:\\ArcGIS\\12.0\\Setups\\DataStore\\SetupFile\\Setup.exe"
    },
    "web_adaptor": {
      "setup": "C:\\ArcGIS\\12.0\\Setups\\WebAdaptorIIS\\Setup.exe"
    }
...
```JSON
{
  "arcgis": {
    ...
    "run_as_password": "<password>",
    "data_store": {
      "setup": "C:\\Users\\Administrator\\Documents\\ArcGIS 12.0\\ArcGISDataStore\\Setup.exe",
      "install_dir": "C:\\Program Files\\ArcGIS\\DataStore",
      "data_dir": "C:\\arcgisdatastore",
      "backup_dir": "C:\\arcgisdatastore\\backup",      
      "install_system_requirements": true,
...
```JSON
{
  "arcgis": {
    ...
    "run_as_password": "<password>",
    "portal": {
      "setup": "C:\\Users\\Administrator\\Documents\\ArcGIS 12.0\\PortalForArcGIS\\Setup.exe",
      "install_dir": "C:\\Program Files\\ArcGIS\\Portal",
      "install_system_requirements":  true,
      "configure_autostart": true,
      "data_dir": "C:\\arcgisportal"
...
```JSON
{
  "arcgis": {
    "version": "12.0",
    "web_adaptor": {
      "setup": "C:\\Users\\Administrator\\Documents\\ArcGIS 12.0\\WebAdaptorIIS\\Setup.exe",
      "install_dir": "",
      "install_system_requirements": true
    },
    "portal": {
...
```JSON
{
  "arcgis": {
    ...
    "run_as_password": "<password>",
    "server": {
      "setup": "C:\\Users\\Administrator\\Documents\\ArcGIS 12.0\\ArcGISServer\\Setup.exe",
      "install_dir": "C:\\Program Files\\ArcGIS\\Server",
      "install_system_requirements": true,
      "configure_autostart": true
    },
...
```JSON
{
  "arcgis": {
    "version": "12.0",
    "server": {
      "lp-setup": "C:\\ArcGIS\\12.0\\Setups\\Server\\Japanese\\setup.msi"
    },
    "portal": {
      "lp-setup": "C:\\ArcGIS\\12.0\\Setups\\Portal\\Japanese\\setup.msi"
    },
    "data_store": {
      "lp-setup": "C:\\ArcGIS\\12.0\\Setups\\DataStore\\Japanese\\setup.msi"
    },
    "web_adaptor": {
      "lp-setup": "C:\\ArcGIS\\12.0\\Setups\\WebAdaptorIIS\\Japanese\\setup.msi"
    }
  },
  "run_list": [
...
```JSON
{
  "arcgis": {
    ...
    "portal": {
      ...
      "security_question_answer": "Gotham",
      "keystore_file": "C:\\certificates\\domain_com.pfx",
      ...
      "email_settings": {
        ...
        "username": "",
        "password": "",
        "fromEmailAddress": "admin@domain.com",
        "fromEmailAddressLabel": "Administrator",
        "authRequired" : false,
...
Configures Portal for ArcGIS security and identity stores.
...
Updates Portal for ArcGIS user default settings.
...
```JSON
{
  ...
  "run_list": [
    "recipe[arcgis-enterprise::portal_settings]"
  ]
}
```
...
```JSON
{
  "arcgis": {
    ...
    "portal": {
      "setup": "C:\\ArcGIS\\12.0\\Setups\\Portal\\Setup.exe",
      "install_dir": "C:\\Program Files\\ArcGIS\\Portal",
      "authorization_file": "C:\\ArcGIS\\12.0\\Authorization_Files\\Portal.prvc",
      "authorization_file_version": "12.0",
      "install_system_requirements":  true,
      "configure_autostart": true,
      "data_dir": "C:\\arcgisportal",
...
```JSON
{
  "arcgis": {
    ...
    "web_adaptor":{
      "setup": "/arcgis/12.0/WebAdaptor/CD_Linux/Setup",
      "install_dir": "/",
      "install_system_requirements": true
    },
    "portal": {
...
```JSON
{
  ...
  "run_list": [
    "recipe[arcgis-enterprise::uninstall_datastore]"
  ]
}
```
...
```JSON
{
  ...
  "run_list": [
    "recipe[arcgis-enterprise::uninstall_portal]"
  ]
}
```
...
```JSON
{
  ...
  "run_list": [
    "recipe[arcgis-enterprise::uninstall_server]"
  ]
}
```

### uninstall_webadaptors

Uninstalls and un-deploys ArcGIS Server and Portal for ArcGIS Web Adaptors.
...
```JSON
{
  "arcgis": {
    ...
    "web_adaptor": {
      "install_dir": "C:\\Program Files\\ArcGIS\\WebAdaptor"
    }
  },
  "run_list": [
    "recipe[arcgis-enterprise::uninstall_webadaptors]"
  ]
}
```
...
```JSON
{
  "arcgis": {
   "version":"12.0",
    "webstyles": {
      "setup":"C:\\ArcGIS\\12.0\\Setups\\ArcGIS 12.0\\ArcGISWebStyles\\Setup.exe"
    }
  },
  "run_list": [
