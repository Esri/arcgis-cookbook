...
The machines must have ArcGIS Server 12.0 installed and authorized. Consult the ArcGIS Server 12.0 system requirements documentation for the required/recommended hardware specification.
