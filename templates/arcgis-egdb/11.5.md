...
The machines must have ArcGIS Server 11.5 installed and authorized. Consult the ArcGIS Server 11.5 system requirements documentation for the required/recommended hardware specification.
