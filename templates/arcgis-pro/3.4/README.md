...
Installs ArcGIS Pro 3.4.

## System Requirements

Consult the ArcGIS Pro 3.4 system requirements documentation for the required/recommended hardware specification.
...
Downloads Microsoft .NET 8 Desktop Runtime x64 setups archive from the S3 bucket.
...
Installs Microsoft .NET 8 Desktop Runtime x64.
...
Downloads Microsoft Edge WebView2 Runtime setups archive from the S3 bucket.
