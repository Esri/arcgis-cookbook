...
Consult the ArcGIS Video Server 12.1 system requirements documentation for the required/recommended hardware specification.
...
* ArcGIS_Video_Server_Windows_121_200179.exe
