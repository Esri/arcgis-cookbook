...
Consult the ArcGIS Video Server 11.5 system requirements documentation for the required/recommended hardware specification.
...
* ArcGIS_Video_Server_Windows_115_195409.exe
