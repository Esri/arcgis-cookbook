...
Consult the ArcGIS Video Server 12.0 system requirements documentation for the required/recommended hardware specification.
...
* ArcGIS_Video_Server_Windows_120_197689.exe
...
### video-server-fileserver

Installs NFS and configures shares for the ArcGIS Video Server configuration store and server directories.
...
Installs ArcGIS Video Server, authorizes the software, and joins the machine to the existing site.
...
* arcgis.video_server.admin_password - Specify primary site administrator account password.
* arcgis.video_server.authorization_file - Specify path to the ArcGIS Video Server role software authorization file.
* arcgis.video_server.primary_server_url - Specify URL of the ArcGIS Video Server site to join.
