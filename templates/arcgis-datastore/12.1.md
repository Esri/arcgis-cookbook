...
Consult the ArcGIS Data Store 12.1 system requirements documentation for the required/recommended hardware specification.
...
To upgrade an ArcGIS Data Store deployed using the arcgis-datastore deployment template to the 12.1 version, you will need:

* ArcGIS Data Store 12.1 setup archive,
...
### Upgrade from 10.9, 10.9.1, 11.0, 11.1, 11.2, 11.3, 11.4, 11.5, or 12.1

Upgrading ArcGIS Data Store deployments from 10.9, 10.9.1, 11.0, 11.1, 11.2, 11.3, 11.4, 11.5, or 12.1 to 12.1 requires upgrading all ArcGIS Data Store machines. The file server machine does not require any changes.
...
1. Upgrade the standby machine.
   ...
   Copy attributes from the original `arcgis-datastore-relational-standby.json` JSON file created from the 10.9, 10.9.1, 11.0, 11.1, 11.2, 11.3, 11.4, or 11.5 arcgis-datastore template to the `arcgis-datastore-install.json` and `arcgis-datastore-relational-standby.json` files of the 12.1 arcgis-datastore template.

   ```shell
   chef-apply ./templates/tools/copy_attributes.rb <original JSON files>/arcgis-datastore-relational-standby.json <arcgis-datastore 12.1 template>/arcgis-datastore-install.json
   
   chef-apply ./templates/tools/copy_attributes.rb <original JSON files>/arcgis-datastore-relational-standby.json <arcgis-datastore 12.1 template>/arcgis-datastore-relational-standby.json
   ```
   ...
   ```shell
   chef-client -z -j <arcgis-datastore 12.1 template>/arcgis-datastore-install.json
   ```

   Save the updated 12.1 `arcgis-datastore-relational-standby.json` file for future upgrades from 12.1.

2. Upgrade the primary machine.

   Copy attributes from the original `arcgis-datastore-relational-primary.json` JSON file created from the 10.9, 10.9.1, 11.0, 11.1, 11.2, 11.3, 11.4, 11.5, or 12.1 arcgis-datastore template to the `arcgis-datastore-relational-primary.json` file of the 12.1 arcgis-datastore template.

   ```shell
   chef-apply ./templates/tools/copy_attributes.rb <original JSON files>/arcgis-datastore-relational-primary.json <arcgis-datastore 12.1 template>/arcgis-datastore-relational-primary.json
   ```
   ...
   ```shell
   chef-client -z -j <arcgis-datastore 12.1 template>/arcgis-datastore-relational-primary.json
   ```
...
1. Upgrade all machines in the cluster
   ...
   Copy attributes from the original `arcgis-datastore-spatiotemporal-node.json` JSON file created from 10.9, 10.9.1, 11.0, 11.1, 11.2, 11.3, 11.4, 11.5, or 12.1 arcgis-datastore template to `arcgis-datastore-install.json` and `arcgis-datastore-spatiotemporal-node.json` of 12.1 arcgis-datastore template.

   ```shell
   chef-apply ./templates/tools/copy_attributes.rb <original JSON files>/arcgis-datastore-spatiotemporal-node.json <arcgis-datastore 12.1 template>/arcgis-datastore-install.json
   
   chef-apply ./templates/tools/copy_attributes.rb <original JSON files>/arcgis-datastore-spatiotemporal-node.json <arcgis-datastore 12.1 template>/arcgis-datastore-spatiotemporal-node.json
   ```
   ...
   Save the updated 12.1 `arcgis-datastore-spatiotemporal-node.json` file for future upgrades from 12.1.

2. Complete the upgrade on any machine in the cluster

   Copy attributes from the original `arcgis-datastore-spatiotemporal.json` JSON file created from the 10.9, 10.9.1, 11.0, 11.1, 11.2, 11.3, 11.4, 11.5, or 12.1 arcgis-datastore template to the `arcgis-datastore-spatiotemporal.json` file of the 12.1 arcgis-datastore template.

   ```shell
   chef-apply ./templates/tools/copy_attributes.rb <original JSON files>/arcgis-datastore-spatiotemporal.json <arcgis-datastore 12.1 template>/arcgis-datastore-spatiotemporal.json
   ```
   ...
   ```shell
   chef-client -z -j <arcgis-datastore 12.1 template>/arcgis-datastore-spatiotemporal.json
   ```
