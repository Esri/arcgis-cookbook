...
Consult the ArcGIS Web Adaptor 12.1 system requirements documentation for the required/recommended hardware specification.
...
### ArcGIS Video Server Web Adaptor Machine

```shell
chef-client -z -j arcgis-video-server-webadaptor.json
```
...
### arcgis-video-server-webadaptor-install
...
### arcgis-video-server-webadaptor-unregister

Unregisters all ArcGIS Web Adaptors from an ArcGIS Video Server site.

Required attributes changes:

* arcgis.video_server.admin_username - Specify ArcGIS Video Server primary site administrator account user name.
* arcgis.video_server.admin_password - Specify ArcGIS Video Server primary site administrator account password.

### arcgis-video-server-webadaptor

Installs and configures Microsoft IIS web server on Windows and Apache Tomcat application server on Linux, installs ArcGIS Web Adaptor and registers it with ArcGIS Video Server.
...
* arcgis.video_server.admin_username - Specify ArcGIS Video Server primary site administrator account user name.
* arcgis.video_server.admin_password - Specify ArcGIS Video Server primary site administrator account password.
* arcgis.video_server.url - Specify ArcGIS Video Server URL.
* arcgis.video_server.wa_url - Specify ArcGIS Web Adaptor URL.
* tomcat.keystore_file - (Linux only) Specify path to the SSL certificate file in PKCS12 format that will be used to configure the HTTPS listener in Apache Tomcat.
* tomcat.keystore_password - (Linux only) Specify password of the SSL certificate file.
