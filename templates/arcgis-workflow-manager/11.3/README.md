...
Consult the ArcGIS Workflow Manager Server 11.3 system requirements documentation for the required/recommended hardware specification.
...
* ArcGIS_Workflow_Manager_Server_113_190273.exe
