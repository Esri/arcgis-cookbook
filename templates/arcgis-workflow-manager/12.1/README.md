...
Consult the ArcGIS Workflow Manager Server 12.1 system requirements documentation for the required/recommended hardware specification.
...
* ArcGIS_Workflow_Manager_Server_121_200180.exe
