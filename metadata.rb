...
recipe 'arcgis::all_uninstalled', 'Uninstalls all ArcGIS software of the specified version'
recipe 'arcgis::clean', 'Deletes local directories created by ArcGIS software'
...
recipe 'arcgis::server_node', 'Installs ArcGIS Server on the machine and joins an existing site'
recipe 'arcgis::server_wa', 'Installs Web Adaptor and configures it with ArcGIS Server'
recipe 'arcgis::portal', 'Installs and configures Portal for ArcGIS on primary machine'
recipe 'arcgis::portal_wa', 'Installs Web Adaptor and configures it with Portal for ArcGIS'
recipe 'arcgis::portal_stanby', 'Installs and configures Portal for ArcGIS on standby machine'
recipe 'arcgis::datastore', 'Installs and configures ArcGIS Data Store on primary machine'
recipe 'arcgis::datastore_standby', 'Installs and configures ArcGIS Data Store on standby machine'
...
recipe 'arcgis::pro', 'Installs ArcGIS Pro'
